...
Cette activité permet de transformer un cours nouveau en une ressource partagable. ceci termine l'existance de la classe correspondantes (gain de place). les données sont fournies au serveur central.
